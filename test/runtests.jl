...
# !!! Main.UserApp is configured as an alias for Main.TimeseriesClusteringAPI and you might encounter it in some tests
using Main.TimeseriesClusteringAPI, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "TimeseriesClusteringAPI tests" begin
  @includetests ARGS
end
